...
architecture rtl of aurora_wrapper_1l is
  ...
  -- attribute mark_debug of gtreset_in       : signal is "true";
  -- attribute mark_debug of system_reset_in  : signal is "true";
  ...
  --signal gtx_rst_cnt    : unsigned(3 downto 0);
  --signal gtx_rst_cnt_tc : std_logic;
...
begin
  ...
  reset         <= not i_reset_n;
  gt_reset_sig  <= not i_gtx_rst_n; --wip: ask what to do about it
