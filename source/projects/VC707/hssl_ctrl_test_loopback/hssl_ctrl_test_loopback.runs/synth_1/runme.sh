...
HD_PWD='d:/work/SFP-Simulation-link/source/projects/VC707/hssl_ctrl_test_loopback/hssl_ctrl_test_loopback.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hssl_ctrl_test_1l_loopback.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hssl_ctrl_test_1l_loopback.tcl
