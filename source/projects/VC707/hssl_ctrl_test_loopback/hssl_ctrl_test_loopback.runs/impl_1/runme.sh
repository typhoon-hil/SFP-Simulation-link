...
HD_PWD='d:/work/SFP-Simulation-link/source/projects/VC707/hssl_ctrl_test_loopback/hssl_ctrl_test_loopback.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hssl_ctrl_test_1l_loopback.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hssl_ctrl_test_1l_loopback.tcl -notrace
